...
export const career: CareerEntry[] = [
  {
    ...
    description:
      "大手企業向けの社内生成 AI アプリケーション開発に立ち上げ初期から参画。チャット・画像生成・RAG・ドキュメント自動生成などの機能を持つ AI 基盤を、顧客との要件調整から設計・開発まで一貫して担当。フロントエンド（TypeScript / React）・バックエンド（Python / FastAPI）・インフラ（Azure）を横断し、5名チームのリーダーとしてメンバー育成やコードレビュー、Linter / Formatter 導入などの品質改善も主導。別案件では Java / Spring Boot によるリビルド案件も経験。",
    highlights: [
      "生成 AI アプリ開発",
      "RAG 精度改善",
      "Azure インフラ設計",
  ...
  },
  {
    ...
    highlights: ["Ruby on Rails", "Next.js"],
  },
  {
    id: "railway",
